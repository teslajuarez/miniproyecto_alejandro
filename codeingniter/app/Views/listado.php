...
<html lang="en">
  <head>
    ...
    <script src="https://unpkg.com/sweetaler/dist/sweetalert.sin.js"></script> 
    <script>
     ...
     let mensaje = '<?php echo $mensaje; ?>';
      if (mensaje == '0'){
        ...
        swal(':D',' registro eliminado correctamente','succes');
      }else if(mensaje == '5'){
        swal(':(','no fue posible eliminar correctamente','error');
